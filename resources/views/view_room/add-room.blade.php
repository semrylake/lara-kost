...
<div class="card mt-3 border shadow">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold">Form Tambah Kamar Kost</h6>
    </div>
    <form class="form-horizontal" action="/addRoom" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input autofocus type="number" name="harga" value="{{ old('harga') }}"
            ...
            <div class="form-group">
                ...
                <input autofocus type="number" name="ukuran" value="{{ old('ukuran') }}"
