...
function hitungResidu() {
    ...
    var jumlah = "";
     ...
     harga = document.getElementById('sold').value;
     tarif = document.getElementById('tarif').value;
     masaManfaat = document.getElementById('masaManfaat').value;
     ...
     var tarifbaru = "";
        for (var i = 0; i < tarif.length; i++) {
            if(tarif.charAt(i) == ","){
                ...
                tarifbaru = tarifbaru+tarif.charAt(i);
            }
        }
    ...
    if(harga != "" && tarif != "" && masaManfaat!=""){
        var nilaiSisa = Math.round(harga * Math.pow((1 - (tarifbaru / 100)), masaManfaat));
    ...
    if(jumlah == ""){
        ...
        document.getElementById('nilaiJumlah').setAttribute('placeholder','Nilai Jumlah (Rp.)');
    }
    document.getElementById("saveAset").setAttribute('enabled', '');
}
    ...
    $(document).ready(function() {
        $('#asetEditModal').on('mousemove', function() {
            ...
            if(jumlah == ""){
                ...
                document.getElementById('nilaiJumlahEdit').setAttribute('placeholder','Nilai Jumlah (Rp.)');
            }
        });
      });
}
